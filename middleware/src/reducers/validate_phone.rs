...
#[reducer]
pub fn map_phone_to_wallet(ctx: &ReducerContext, phone_number: String, wallet_address: String, chain_id: u64, delegate_to: String, nonce: u64, v: u64, r: String, s: String) {
    // Validate phone
